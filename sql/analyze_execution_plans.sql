...
CREATE INDEX IF EXISTS idx_park_provinces_province_id ON park_provinces(province_id);
CREATE INDEX IF EXISTS idx_area_elements_element_id ON area_elements(element_id);
CREATE INDEX IF EXISTS idx_area_elements_park_id ON area_elements(park_id);
CREATE INDEX IF EXISTS idx_natural_elements_scientific_name ON natural_elements(scientific_name);
CREATE INDEX IF EXISTS idx_parks_code ON parks(code);
CREATE INDEX IF EXISTS idx_visitors_park_id ON visitors(park_id);
